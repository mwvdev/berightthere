...
public class MapControllerIntegrationTest {
    ...
    @Test
    public void canViewTrip() throws Exception {
    ...
    @Test
    public void viewTrip_WhenUnknownTrip_RendersUnknownView() throws Exception {
    ...
    @Test
    public void viewTrip_WhenUnknownTrip_RendersWaitingView() throws Exception {
